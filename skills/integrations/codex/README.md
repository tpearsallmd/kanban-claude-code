...
# Extract Codex-specific integration files to your skills directory
...
This installs the skills to `~/.codex/skills/kanban/` with the expected structure:
